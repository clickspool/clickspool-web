export default [
  ...
  // app
  {
    ...
    routes: [
      { path: '/', redirect: '/operation/user/list', },
      {
        path: '/operation',
        name: 'operation',
        icon: 'desktop',
        ...
        routes: [
          ...
          {
            path: '/operation/assistant/messagepush/update/:id?/:copy?',
            component: './Operation/messagePush/update',
          },
          {
            path: '/operation/messagepush/detail/:id?',
            component: './Operation/messagePush/detail',
          },
          {
