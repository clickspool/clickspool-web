...
@connect(
  ({
    permission: { roleList, statusList,purchaseList:data },
    routing: {
      location: { pathname },
    },
    memberInfo: {
...
class Permission extends PureComponent {
  ...
  updataConfiList() {
    ...
    dispatch({
      type: 'permission/fetchPurchaseList',
      payload: pagination,
    });
  }
  ...
  render() {
    ...
    const columns = [
      ...
      {
        title: 'User coupons code',
        dataIndex: 'user_coupons_code',
        key: 'user_coupons_code',
      },
      {
        title: 'Product unit',
      ...
      {
        title: 'Product expire time',
        dataIndex: 'product_expire_time',
        key: 'product_expire_time',
      },
      {
        title: 'Purchase title',
        dataIndex: 'purchase_title',
        key: 'purchase_title',
      },
      {
        title: 'Purchase product id',
        dataIndex: 'purchase_product_id',
        key: 'purchase_product_id',
      },
      {
      ...
      {
        title: 'Purchase local amount',
        dataIndex: 'purchase_local_amount',
        key: 'purchase_local_amount',
      },
      {
      ...
      {
        title: 'Purchase pay type',
        dataIndex: 'purchase_pay_type',
        key: 'purchase_pay_type',
      },
      {
        title: 'Purchase is test',
        dataIndex: 'purchase_is_test',
        key: 'purchase_is_test',
      },
      {
        title: 'Created time',
