import { delSeedUser } from '@/services/users';
...
@connect(
  ({
    seed: { data, info ,regionMap,languageMap},
    routing: {
      location: { pathname },
    },
    memberInfo: {
...
class Seed extends PureComponent {
  ...
  render() {
    ...
    const { previewVisible, previewImage,breadcrumb } = this.state;
    const rowSelection = {
      ...
      <div>
        <div className={styles.breadcrumbBox}>
          <Breadcrumb>
            ...
            <Breadcrumb.Item>{formatMessage({ id: 'menu.operation.user.seed' })}</Breadcrumb.Item>
          </Breadcrumb>
        </div>
        ...
        <Popconfirm title="Sure to del?" onConfirm={this.delUser.bind(this,this.state.selectedRows)}>
