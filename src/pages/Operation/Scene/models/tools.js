...
import { create, fetch, patch, fetchCates, fetchStatuses, fetchPositions, fetchClients, patchStatus, batchModify, deleteTool } from '../services/tools';
export default {
  state: {
    list: [],
    total: null,
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      return history.listen(({ pathname, search }) => {
        ...
        if (pathname === '/operation/videoscene/tools') {
