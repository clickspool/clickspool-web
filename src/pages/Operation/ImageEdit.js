...
class ImageEdit extends React.Component {
  onOk = () => {
    ...
    form.validateFields((error, value) => {
      ...
      let param = !pictureUrl
        ? _.merge({}, editInfo, va)
        : _.merge({}, editInfo, va, { picture_url: pictureUrl });
  ...
  uploadImage = () => {
    ...
    if (uploadImgFile.files[0] && _URL.createObjectURL(uploadImgFile.files[0])) {
  ...
  render() {
    ...
    const rangeConfig = {
      ...
      initialValue: [moment(editInfo.start_time), moment(editInfo.end_time)],
    };
    return (
      !!visible && (
        <Modal
          ...
          <Form>
            ...
            <Row>
              <Col span={12}>
                ...
                <Col span={10}>
                  <img src={editInfo.picture_url} className={styles.aUploadImg} ref="uploadImg" />
                </Col>
              </Col>
              <Col span={12}>
                <FormItem {...formItemLayout} label={formatMessage({ id: 'app.global.form.type' })}>
                  {getFieldDecorator('status', { initialValue: editInfo.status })(
                    <Select>
              ...
              <Col span={12}>
                ...
                >
                  {getFieldDecorator('link_url', {
                    initialValue: editInfo.link_url,
                    rules: [
                      {
                        required: true,
